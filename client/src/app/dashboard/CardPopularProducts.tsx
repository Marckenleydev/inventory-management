...
function CardPopularProducts() {
  ...
  return (
    <div className='row-span-3  xl:row-span-6 bg-white rounded-2xl shadow-md pb-16'>
        {isLoading ? (
         ...
         <div className='overflow-auto h-full'>
            {dashboardMetrics?.popularProducts.map((product)=>(
                <div key={product.productId} className='flex items-center justify-between gap-5 px-5 py-7 border-b'>

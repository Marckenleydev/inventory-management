        ...
        <div className='flex justify-between items-center gap-5'>
            <div className="hidden md:flex justify-between items-center gap-5">
              ...
              {isDarkMode ? (
                ...
                <span className='absolute -top-2 -right-2 inline-flex items-center justify-center px-[0.4rem] py-1 text-xs font-semibold leading-none text-red-100 bg-red-500 rounded-full'>2</span>
